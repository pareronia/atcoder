package com.github.pareronia.atcoder.abc._212.d;
...
/**
 * D - Querying Multiset
 * @see <a href="https://atcoder.jp/contests/abc212/tasks/abc212_d">https://atcoder.jp/contests/abc212/tasks/abc212_d</a>
 */
public class Main {
    ...
    private Result<?> handleTestCase(final Scanner sc, final Integer i) {
        ...
        final List<Long> anss = new ArrayList<>();
        final PriorityQueue<Long> bag = new PriorityQueue<>();
        long added = 0;
        for (int j = 0; j < q; j++) {
            final int n = sc.nextInt();
            if (n == 1) {
                bag.add(sc.nextLong() - added);
            } else if (n == 2) {
                added += sc.nextLong();
            } else {
                anss.add(bag.poll() + added);
            }
        }
