package com.github.pareronia.atcoder.abc._212.c;
...
/**
 * C - Min Difference
 * @see <a href="https://atcoder.jp/contests/abc212/tasks/abc212_c">https://atcoder.jp/contests/abc212/tasks/abc212_c</a>
 */
public class Main {
    ...
    private Result<?> handleTestCase(final Scanner sc, final Integer i) {
        ...
        int k = 0;
        while (j < n && k < m) {
            ans = Math.min(ans, Math.abs(a[j] - b[k]));
            if (a[j] < b[k]) {
                j++;
            } else {
                k++;
