package com.github.pareronia.atcoder.abc._211.a;
...
/**
 * A - Blood Pressure
 * @see <a href="https://atcoder.jp/contests/abc211/tasks/abc211_a">https://atcoder.jp/contests/abc211/tasks/abc211_a</a>
 */
public class Main {
    ...
    private Result<?> handleTestCase(final Scanner sc, final Integer i) {
        ...
        final double c = (a - b) / 3d + b;
        final String ans = String.format("%.6f", c);
